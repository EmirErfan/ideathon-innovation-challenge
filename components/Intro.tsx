  ...
  return (
    <section id="intro" className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">IDEATHON</h2>
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-2/3 md:pl-16">
            <p className="text-lg leading-relaxed text-gray-300">
              Ideathon ialah sebuah pertandingan atau acara di mana peserta berkumpul secara berkumpulan untuk memberikan idea-idea inovatif dalam tempoh masa yang terhad. Serupa dengan Hackathon, tetapi lebih tertumpu kepada mencipta konsep berbanding teknikal.
            </p>
          </div>
        </div>
      </div>
